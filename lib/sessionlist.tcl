...
#
# The left pane's two toggles - running_only, bookmarked_only - choose which
# subset of the result set the list SHOWS. They are not search and not scope:
# changing one narrows or widens what is displayed; it does not re-run a search
# or change which sessions are eligible. They live under the snapshot's
