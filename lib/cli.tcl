...
# ::fms::cli - parse a command-line criterion chain into the same criteria
# the toolbar produces, so fms can launch the GUI pre-seeded with them. A
...
proc ::fms::cli::parse {argv} {
    if {[llength $argv] == 0 || [llength $argv] % 2 != 0} { ::fms::cli::usage }
    set criteria [list]
