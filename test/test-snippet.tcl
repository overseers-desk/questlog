...
# Unit test for ::fms::search::snippet_window - the hit-centred match window
...
set w [::fms::search::snippet_window $mid NEEDLE -nocase]
...
set w [::fms::search::snippet_window $head NEEDLE -nocase]
...
set w [::fms::search::snippet_window $tail NEEDLE -nocase]
...
set w [::fms::search::snippet_window "a NEEDLE b" NEEDLE -nocase]
check "short content returned whole" $w "a NEEDLE b"

# Case-insensitive flag honoured.
set w [::fms::search::snippet_window "found a needle here" NEEDLE -nocase]
