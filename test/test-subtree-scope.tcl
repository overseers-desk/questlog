...
check cand_exact      1 [::questlog::filter::folder_subtree_candidate -home-test-code-proj $U]
check cand_child      1 [::questlog::filter::folder_subtree_candidate -home-test-code-proj-sub $U]
check cand_hyphen_sib 1 [::questlog::filter::folder_subtree_candidate -home-test-code-proj-x $U]
check cand_other      0 [::questlog::filter::folder_subtree_candidate -home-test-code-other $U]
