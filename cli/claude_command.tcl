...
Bound the whole result with `--since <24h|7d|2w|2026-04-01|all>`, `--until <...>`, `--under <dir>`, or `--limit <N>`. Use the words from the user's own request (a topic, a filename, a tool name), and reach for `--regex` only when a literal keyword will not do. The full clause and bound inventory is in `questlog --help`.
